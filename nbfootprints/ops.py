...
def calc_overhanging_veg(geom, image, geom_buffer_size=0.0003, return_chips=False):
    ...
    # calc pct overhnging
    pct_overhanging_trees = float(overhanging_trees.sum()) / bldg_array.sum()
    ...
    if return_chips is False:
        ...
        bldg_colored[:, :, 0][overhanging_trees_with_bldg == 1] = 180 / 255.
        bldg_colored[:, :, 1][overhanging_trees_with_bldg == 1] = 180 / 255.
        bldg_colored[:, :, 2][overhanging_trees_with_bldg == 1] = 180 / 255.
        bldg_colored[:, :, 0][overhanging_trees_with_bldg == 2] = 0 / 255.
        bldg_colored[:, :, 1][overhanging_trees_with_bldg == 2] = 255 / 255.
        bldg_colored[:, :, 2][overhanging_trees_with_bldg == 2] = 23 / 255.
